...
- [ ] Legitimate educational interest is validated before granting internal staff access (CWE-285)
...
- [ ] Age gate or date-of-birth collection determines if user is under 13 (CWE-287)
...
- [ ] Chat, messaging and social features have safety controls for child users (CWE-284)
- [ ] User-generated content from children is moderated before public display (CWE-284)
...
- [ ] Audit logs are retained for the institution's required compliance period (CWE-779)
