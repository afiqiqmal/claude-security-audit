...
- [ ] Introspection is disabled in production (CWE-200)
...
- [ ] Service mesh policies restrict which services can communicate (CWE-284)
...
- [ ] Internal service endpoints are not exposed to the public network (CWE-668)
...
- [ ] Broadcast messages are scoped to authorized subscribers only (CWE-284)
...
- [ ] Consumer groups have ACLs restricting topic access (CWE-284)
